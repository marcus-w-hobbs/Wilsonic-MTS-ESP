...
**2026-08-18 — MUR-002: Wilson's raga lattice is a 53-tone kleismic/schismatic 5-limit lattice, not a 22-śruti one; the 22-śruti set is a fifth-chain window modulo the schisma; the ṣaḍja-grāma is strictly proper and its Ni- and Ma-mūrchanās ARE Bilawal and Khamaj; the grāma shift is a comma perturbation that GAINS triads; and the schisma is a constant-structure phase transition.** (EXECUTED, exact-rational; `results/mur002.jsonl` + `results/mur002_summary.json`, bit-identical across two runs; runner `mur002.py`; transcription `MUR002_TRANSCRIPTION.md`, LatticingRagaScales.pdf read in place pp. 1–26; frozen scorer v1.1.0 and melodic v0.1.0 read-only.) Primary source, transcribed with page cites: Hanson's 1942 "Major-Minor Triadic Lattice for 53" as constant background, eighteen ragas as red-dot subsets (pp. 2–19; every one a union of ≤ 2 fifth-chains a 5/4 apart, spelled with schisma-twins 135/128, 405/256, 1215/1024, 3645/2048), and the p.20 "theoretical scale of 22 steps, of modern India" with Wilson's own note that those spellings are schismatically equivalent to 256/243, 128/81, 32/27. Results: (H-R1 KEPT) ṣaḍja-grāma = Wilson's "Old Kafi" (p.16) and the derived madhyama-grāma are both strictly proper and CS with identical frozen melodic triples; Bilawal (p.18) and Khamaj (p.17) are EXACT rotations of the ṣaḍja-grāma (Ni, Ma), of neither is the madhyama-grāma the parent; Kafi/Kalyan/Asawari/Bhairavi match a ṣaḍja mūrchanā's coarse word with 2/2/2/5 comma-shifted tones. (H-R2 structurally KEPT, exact count missed by a hand slip) the 22-śruti set is not a MOS (3 gaps), improper, CS at 0.5¢, exact P = S = 48 (predicted 45 — the 18:25:32 primitive AP class was omitted), 53-degrees exactly the chain of 22 fifths −10..+11, matched 22/22 within 2¢ by a Pythagorean 22-chain (max deviation one schisma), vs 5/22 for 22-EDO and 10/22 for orwell-22 at 5¢ — a different object from BRIDGE-001's orwell window; all 18 ragas ⊆ 22-śruti modulo 53, only 7 exactly. (H-R3 KEPT) exact and tempered (P, S) are rotation-invariant on all 21 scales × all rotations × all ε — murchana is harmonically and melodically free under the frozen scorers on lattice subsets too. (H-R4 direction KEPT, count off by one) ṣaḍja → madhyama (Pa 3/2 → 40/27) leaves M1–M3 unchanged and RAISES exact triads (11, 7) → (13, 10): a comma perturbation that gains coincidences, the sign-opposite of SHADOW-001 H-S1, by H-S3's connectivity mechanism. (H-R5 KEPT, sharp) CS violations of the exact 22-śruti set are 0 for ε_CS ≤ 1.9¢ and 30 for ε_CS ≥ 2.0¢ — a step at the schisma 1.9537¢ — and its 53-EDO image is non-CS with the fifth at 12 and 13 steps; post-hoc, the ragas show the same: CS 7/18 as drawn, 16/18 śruti-spelled, 7/18 at 53. Post-hoc bonus: Wilson's schismatic spellings never lose and six times gain exact triads over the śruti spelling — the "Major-Minor Triadic Lattice" placement is triad-optimal by machine check. Program consequence: the melodic axis is mode-blind by theorem, and everything the grāma/mūrchanā system encodes lives in a tonic-anchored M4 (proposal in LOG.md) — the next decision point.
